...
if($session->logged_in){
   ...
   echo "<p>We're sorry <b>" . htmlspecialchars(trim($session->username)) . "</b>, but you've already registered. "
...
//          ."you may now <a href=\"main.php\">log in</a>.</p>";
      echo "<p>Thank you <b>" . htmlspecialchars(trim($_SESSION['reguname'])) . "</b>, your information has been added to the database, "
          ."you may now <a href=\"main.php\">log in</a>.</p>";
   }
   /* Registration failed */
   else{
